...
SELECT									'TECH_WOOD_CLEARING',				    'TECH_FIRE'				        UNION ALL
SELECT									'TECH_WOOD_CLEARING',				    'TECH_TOOLS'				    UNION ALL


SELECT									'TECH_AGRICULTURE',						'TECH_FIRE'				        UNION ALL
SELECT									'TECH_ANIMAL_HUSBANDRY',				'TECH_HUNTING'				    UNION ALL
...
SELECT									'TECH_ARCHERY',							'TECH_WARFARE'				    UNION ALL
...
SELECT									'TECH_ECONOMY_OF_SCALE',				'TECH_TOOLS'			        UNION ALL
SELECT									'TECH_TRIBAL_WARRIOR',					'TECH_SCOUTING'					UNION ALL
SELECT									'TECH_COPPER_WORKING',					'TECH_BRONZE_WORKING'			UNION ALL
...
SELECT									'TECH_IDOLS',				            'TECH_LEADERSHIP'		        UNION ALL
SELECT									'TECH_POLYTHEISM',				        'TECH_IDOLS'			        UNION ALL


SELECT									'TECH_ORAL_TRADITION',				    'TECH_LANGUAGE'			        UNION ALL
SELECT									'TECH_FOLKLORE',				        'TECH_ORAL_TRADITION'			UNION ALL
SELECT									'TECH_ART',				                'TECH_SOCIAL_STRUCTURE'			UNION ALL
...
SELECT									'TECH_CEREMONIAL_BURIAL',				'TECH_TOOLS'		            UNION ALL
...
SELECT									'TECH_ALGEBRA',						    'TECH_DRAMA'					UNION ALL
...
SELECT									'TECH_SANITARY_ENGINEERING',			'TECH_MACHINERY'			    UNION ALL
...
SELECT									'TECH_NAVAL_TACTICS',				    'TECH_NAVIGATION'				UNION ALL
...
SELECT									'TECH_RIFLING',							'TECH_FERTILIZER';
...
SELECT									'TECH_SKYSCRAPER',						'TECH_MACRO_ENGINEERING'	    UNION ALL
...
SELECT									'TECH_PHARMACEUTICALS',					'TECH_BIOLOGY'					UNION ALL
...
SELECT									'TECH_TRACKED_VEHICLES',				'TECH_COMBUSTION'			    UNION ALL
...
SELECT									'TECH_RADAR',							'TECH_SONAR'			        UNION ALL
...
SELECT									'TECH_COMBUSTION',						'TECH_STEALTH';
...
SELECT									'TECH_RADIO',							'TECH_STEALTH'					UNION ALL
