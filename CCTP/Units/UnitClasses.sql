...
SELECT						'UNITCLASS_CAVEMAN',					    'TXT_KEY_UNIT_CAVEMAN',				        -1,					-1,					-1,					0,					    'UNIT_CAVEMAN'					    UNION ALL
SELECT						'UNITCLASS_FIRE_EATER',					    'TXT_KEY_UNIT_FIRE_EATER',				    -1,					-1,					-1,					0,					    'UNIT_FIRE_EATER'					UNION ALL
SELECT						'UNITCLASS_SAVAGE',					        'TXT_KEY_UNIT_SAVAGE',				        -1,					-1,					-1,					0,					    'TXT_KEY_UNIT_SAVAGE'				UNION ALL
SELECT						'UNITCLASS_KNIGHT_TEMPLAR',					 'TXT_KEY_UNIT_KNIGHT_TEMPLAR',			    -1,					-1,					-1,					0,					    'TXT_KEY_KNIGHT_TEMPLAR'		    UNION ALL


SELECT						'UNITCLASS_SPION',					          'TXT_KEY_UNIT_SPION',			            -1,					-1,					-1,					0,					    'TXT_KEY_SPION'		                UNION ALL
