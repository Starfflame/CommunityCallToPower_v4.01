...
--	SetVolumeKnobValue(GetVolumeKnobIDFromName("USER_VOLUME_SFX"), 0);
--	SetVolumeKnobValue(GetVolumeKnobIDFromName("USER_VOLUME_SPEECH"), 0);
--	SetVolumeKnobValue(GetVolumeKnobIDFromName("USER_VOLUME_AMBIENCE"), 0);
