...
INSERT INTO GameSpeeds		(ID, Type,					Description,					Help,								DealDuration,	GrowthPercent,	TrainPercent,	ConstructPercent,  LeaguePercent,	CreatePercent,	ResearchPercent,	GoldPercent,	GoldGiftMod,	BuildPercent,	ImprovementPercent, GreatPeoplePercent, CulturePercent, FaithPercent,	BarbPercent,	FeatureProductionPercent,	UnitDiscoverPercent,	UnitHurryPercent,	UnitTradePercent,	GoldenAgePercent,	HurryPercent,	InflationPercent,	InflationOffset,	ReligiousPressureAdjacentCity,	VictoryDelayPercent,	MinorCivElectionFreqMod,	OpinionDurationPercent, SpyRatePercent, PeaceDealDuration,	RelationshipDuration,	PortraitIndex,	IconAtlas)
				 ...
				 SELECT		 0,	 'GAMESPEED_MARATHON',	'TXT_KEY_GAMESPEED_MARATHON',	'TXT_KEY_GAMESPEED_MARATHON_HELP',	90,				450,			250,			250,	              200,			250,			450,				250,			67,				250,			300,				200,				300,			250,			150,			250,						375,					375,				300,				200,				100,			5,					-330,				2,								300,					300,						300,					100,			30,					150,					0,				'GAMESPEED_ATLAS'		UNION ALL
				 SELECT		 1,	 'GAMESPEED_EPIC',		'TXT_KEY_GAMESPEED_EPIC',		'TXT_KEY_GAMESPEED_EPIC_HELP',	    45,				225,			135,			135,	              135,			150,			225,				150,			75,				150,			225,				150,				188,			188,			150,			150,						188,					188,				150,				125,				100,			10,					-169,				4,								150,					150,						150,					100,			15,					75,						1,				'GAMESPEED_ATLAS'		UNION ALL
				 SELECT		 2,	 'GAMESPEED_STANDARD',	'TXT_KEY_GAMESPEED_STANDARD',	'TXT_KEY_GAMESPEED_STANDARD_HELP',	30,				115,			90,				80,		              100,			85,				95,				    95,				100,	        100,			100,				100,				120,			120,			100,			100,						125,					95,					100,				100,				95,				20,					-112,				6,								100,					100,						100,					100,			10,					50,						2,				'GAMESPEED_ATLAS'		UNION ALL
				 SELECT		 3,	 'GAMESPEED_QUICK',		'TXT_KEY_GAMESPEED_QUICK',		'TXT_KEY_GAMESPEED_QUICK_HELP',     25,				84,				67,				67,		              67,			67,				84,					67,				125,			67,				84,					67,					84,				84,				67,				67,							84,						84,					67,					80,					100,			35,					-90,				9,								67,						67,							67,						30,				10,					50,						3,				'GAMESPEED_ATLAS';
...
SELECT						'GAMESPEED_MARATHON',	240,			100					 UNION ALL -- Ancient
SELECT						'GAMESPEED_MARATHON',	180,			300					 UNION ALL -- Classical
SELECT						'GAMESPEED_MARATHON',	120,			170					 UNION ALL -- Medieval
SELECT						'GAMESPEED_MARATHON',	60,				201					 UNION ALL -- Renassiance
SELECT						'GAMESPEED_MARATHON',	24,				129					 UNION ALL -- Industrial
SELECT						'GAMESPEED_MARATHON',	12,				180					 UNION ALL -- Modern
SELECT						'GAMESPEED_MARATHON',	6,				264					 UNION ALL -- Post Modern
SELECT						'GAMESPEED_MARATHON',	3,				156					 UNION ALL -- Future
-- Slow
...
-- Normal
SELECT						'GAMESPEED_STANDARD',	480,			75					 UNION ALL -- Ancient 1000bc
SELECT						'GAMESPEED_STANDARD',	280,			75					 UNION ALL -- Classical 750bc
SELECT						'GAMESPEED_STANDARD',	88,				75					 UNION ALL -- Medieval 1300
SELECT						'GAMESPEED_STANDARD',	64,				75					 UNION ALL -- Renassiance 1700
SELECT						'GAMESPEED_STANDARD',	28,				75					 UNION ALL -- Industrial 1875
SELECT						'GAMESPEED_STANDARD',	18,				75					 UNION ALL -- Modern 1987.5
SELECT						'GAMESPEED_STANDARD',	4,				75					 UNION ALL -- Post Modern 2012.5
SELECT						'GAMESPEED_STANDARD',	1,				150					 UNION ALL -- Future ...
-- Fast
